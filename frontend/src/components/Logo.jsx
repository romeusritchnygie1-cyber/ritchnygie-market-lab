export default function Logo({ size = 30 }) {
    return (
        <div className="flex items-center gap-3" aria-label="Ritchnygie Trading Lab">
            <svg
                width={size}
                height={size}
                viewBox="0 0 40 40"
            ...
            <div className="leading-none">
                <div className="font-headings font-bold text-[24px] tracking-[-0.02em] text-white">RTL</div>
                <div className="text-[10px] tracking-[0.30em] uppercase font-headings txt-mute mt-1">
                    Ritchnygie · Lab
                </div>
            </div>
        </div>
